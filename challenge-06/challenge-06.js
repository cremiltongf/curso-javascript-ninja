...
desafio.
*/
let teams = ['Athletico-PR', 'Bahia', 'Flamengo', 'Botafogo', 'São Paulo'];
...
function showTeamPosition(pos) {
    return !!pos && pos <= 5 ? `O time que está em ${pos}º lugar é o ${teams[pos - 1]}.` : `Não temos a informação do time que está nessa posição.`;
};
