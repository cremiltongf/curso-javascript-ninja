(function() {
  ...
  */
  ...
  console.log( sum( 9, 8, 7, 6, 5, 4, 3, 2, 1 ) ); // 45
  ...
  */
  ...
  e remove tudo o que não for número (substituindo por ",") e retornando um array somente com os números
  ...
  */
  ...
  function justNumbers( num ) {
    if( num ) {
      let regex = /\D+/g;
      let cleanNumbers = num.replace( regex, ',').split( ',' );
      return cleanNumbers;
    }
  }
