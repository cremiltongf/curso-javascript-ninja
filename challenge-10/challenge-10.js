(function() {
    ...
    */
    ...
    if( sum ) {
        number1 = 12;
        number2 = 13;
        console.log( showOperationMessage( operationSignal, number1, number2 ), sum( number1, number2 ) ); // 25
    } else {
    ...
    */
    ...
    if( subtraction ) {
        number1 = 120;
        number2 = 13;
        console.log( showOperationMessage( operationSignal, number1, number2 ), subtraction( number1, number2 ) ); // 107
    } else {
        console.log( showErrorMessage( operationSignal) );
    }
    ...
    if( division ) {
        number1 = 160;
        number2 = 4;
        console.log( showOperationMessage( operationSignal, number1, number2 ), division( number1, number2 ) ); // 40
    } else {
        console.log( showErrorMessage( operationSignal) );
    }
    ...
    if( mod ) {
        number1 = 17;
        number2 = 2;
        console.log( showOperationMessage( operationSignal, number1, number2 ), mod( number1, number2 ) ); // 1
    } else {
        console.log( showErrorMessage( operationSignal) );
    }
    ...
    */
    ...
    if( invalid ) {
        ...
        console.log( showErrorMessage( operationSignal) ); // Operação 10 não permitida!
    }
