(function() {
    ...
    */
    ...
    let arr = [ 'Olá', 'mundo!', 'Como', 'vai', 'o', 'aprendizado?', 10, '?' ];
    ...
    */
    ...
    // alternativa com unshift();
    // exemplo: brasil.unshift( 'Acre', 'Amapá', 'Amazonas' );
    console.log( brasil );
    ...
    */
    let newSul = brasil.filter( function( item ) {
        if( item === 'Paraná' || item === 'Santa Catarina' || item === 'Rio Grande do Sul' ) {
            return item;
        }
    });
    ...
    */
    ...
    let letters = brasil.every( function( item ) {
        return item.length > 7;
    });
    letters = letters ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!';
    console.log( letters );
    ...
    */
    ...
    ceara = ceara ? 'Ceará está incluído!' : 'Ceará não foi incluído :(';
    console.log( ceara );
