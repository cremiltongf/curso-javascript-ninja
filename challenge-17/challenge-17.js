(function() {
    ...
    */
    ...
    let replaceName = text.replace( /Manuel Marques de Sousa/gi, 'Cremilton Gonçalves Fernandes' );
    ...
    */
    ...
    let replaceNationality = text.replace( /brasileiro/gi, 'japoranense' );
    console.log( replaceNationality );
    ...
    */
    ...
    let replaceNumber = text.replace( /\d/gi, '-' );
    ...
    */
    ...
    let replaceLetters = text.replace( /[D-Hd-h]/gi, 0 );
    ...
    */
    ...
    let replaceA = text.replace( /a/gi, '4' );
    ...
    */
    ...
    let replaceReference = text.replace( /O Centauro de Luvas/gi, function( phrase ) {
        return phrase.toUpperCase();
    } );
    console.log( replaceReference );
